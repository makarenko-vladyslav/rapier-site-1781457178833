...
export const metadata: Metadata = {
  ...
  description: "Професійна служба прибирання для приватних осель та офісів. Німецьке обладнання, екологічні засоби, страхування майна до 50,000 грн. Прибуття за 60 хвилин.",
